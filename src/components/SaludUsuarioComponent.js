...
// Estilos CSS
import "../pages/styles/SaludUsuario.css";
...
export default function SaludUsuarioComponent({ id, Data }) {
              ...
              <div className="datos-usuario_container">
                ...
                <div className="UserInformation_container">
                  <List disablePadding className="RevisarAutodiagnostico-List mb-3">
                    ...
                    <ListItem>
                      <ListItemText primary="Enfermedad actual" secondary={Data.enfermedadActual} />
                    </ListItem>
                    <Divider />
